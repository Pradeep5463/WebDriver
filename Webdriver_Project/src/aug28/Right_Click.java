...
public class Right_Click {
	...
	public static void main(String[] args) throws Throwable {
		...
		ac.moveToElement(driver.findElement(By.xpath("(//*[@class='gb_y'])[1]"))).contextClick().perform();
		Thread.sleep(5000);
		...
		Thread.sleep(5000);
		ac.moveToElement(driver.findElement(By.xpath("(//*[@class='laptop-desktop-only'])[1]"))).click().perform();
		Thread.sleep(5000);
		driver.close();
		//switch to parent window google and click images
		driver.switchTo().window(brw.get(0));
		Thread.sleep(5000);
		ac.moveToElement(driver.findElement(By.xpath("(//*[@class='gb_y'])[2]"))).click().perform();
		Thread.sleep(5000);
		driver.close();
